  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-3 col-md-6 mb-4 mb-lg-0">
        ...
        <p>
          Experience luxury and comfort at our hotel. We provide exceptional
          service and amenities to make your stay memorable.
        </p>
      ...
      <div class="col-lg-3 col-md-6 mb-4 mb-lg-0">
        ...
        <ul class="list-unstyled">
          ...
          <li class="mb-2">
            <a href="rooms" class="text-white text-decoration-none">Rooms</a>
          </li>
          <li class="mb-2">
