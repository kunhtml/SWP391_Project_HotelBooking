    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-3 col-md-6 mb-4 mb-lg-0">
                <h5 class="text-uppercase mb-4">Hotel Booking</h5>
                <p>Experience luxury and comfort at our hotel. We provide exceptional service and amenities to make your stay memorable.</p>
            ...
            <div class="col-lg-3 col-md-6 mb-4 mb-lg-0">
                ...
                <ul class="list-unstyled">
                    <li class="mb-2"><i class="fas fa-map-marker-alt me-2"></i>123 Hotel Street, City, Country</li>
                    <li class="mb-2"><i class="fas fa-phone me-2"></i>+1 234 567 890</li>
                    <li class="mb-2"><i class="fas fa-envelope me-2"></i>info@hotelbooking.com</li>
                </ul>
            </div>
            <div class="col-lg-3 col-md-6 mb-4 mb-lg-0">
